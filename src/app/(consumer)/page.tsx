          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            {ENTRY_CARDS.map((card) => (
              <Link
                key={card.href}
                href={card.href}
                className={`flex flex-col items-center justify-center gap-2 rounded-2xl border px-2 py-8 text-center transition hover:-translate-y-0.5 hover:shadow-md sm:px-4 sm:py-10 ${card.classes}`}
              >
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {SOON_CARDS.map((card) => (
              <Link
                key={card.href}
                href={card.href}
                className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-black/10 bg-black/[0.02] p-4 text-center text-black/50 transition hover:border-black/20 dark:border-white/10 dark:bg-white/5 dark:text-white/50"
              >
