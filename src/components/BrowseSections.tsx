...
import type { getHomeData } from "@/lib/homeData";
      ...
      <section className="mt-12">
        ...
        <ScrollReveal>
          <div className="mt-4 flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 snap-x snap-mandatory sm:mx-0 sm:px-0">
            ...
            >
              <Image src="/hero-drone.png" alt="" fill sizes="160px" className="object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
              <div className="absolute inset-x-0 bottom-0 p-2 text-white">
                <p className="text-sm font-semibold">드론 방제</p>
                <p className="text-[11px] opacity-90">평당 {formatPrice(RICE_UNIT_PRICE)}~</p>
              </div>
            </Link>
